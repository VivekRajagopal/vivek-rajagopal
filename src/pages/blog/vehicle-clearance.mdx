...
date: 2019-03-17
description: An explanation of vehicle clearance templates
---
...
No fun in reading all this if you can't _take it for a ride_ right? I built a quick little app with **ReactJS** and **PaperJS** (a great Vector Graphics JS Library).
